...
/**
 * Get the next lower version from the available versions list.
 *
 * It uses getAvailableVersions() to retrieve the version list.
 * The raw JSON is an array sorted in descending order.
